...
import {
  multiplicationGroupHeaders,
  multiplicationRedirectUrls,
  multiplicationWorksheetsImages
} from "../Data/data";
      ...
      <div className="py-32 flex justify-center">
        ...
        <div className="flex w-full">
          <div className="flex flex-col">
            ...
            Multiplication Math Facts Worksheets
            </h1>
            <p>
            ...
            <div className="grid grid-cols-4">
              {multiplicationWorksheetsImages.map((img, i) => (
                <>
                  {i % 4 === 0 && (
                    <h3 className="col-span-4 text-xl font-semibold mt-6 mb-2">
                      {multiplicationGroupHeaders[i / 4]}
                    </h3>
                  )}
                  <Link to={multiplicationRedirectUrls[i]}>
                    <img
                      src={img}
                      alt=""
...
export default MultiplicationWorksheets;
