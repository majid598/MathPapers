...
import { multiplicationWorksheets } from "../Data/data";
        ...
        <div className="flex w-full">
          <div className="flex flex-col">
            <div className="lg:px-0 md:px-10 sm:px-8 px-4">
              ...
              <p>
                These multiplication worksheets are similar to the
                <a
                ...
                , <i>Wolf Swamp</i> or <i>Mastering Math Facts</i> multiplication
